...
//     WITH CHECK: (EXISTS ( SELECT 1    FROM professional_client_links   WHERE ((professional_client_links.client_id = nutrition_assessments.client_id) AND (professional_client_links.professional_id = auth.uid()))))
