import {
  ...
  x as useControllableState,
} from './dist-zdF_4_x7.js'
import './dist-SZMMwwRy.js'
import {
  i as createContextScope$1,
  n as AvatarFallback,
  p as Check,
  r as AvatarImage,
  t as Avatar,
...
var CheckItem = ({ id, label, border = true }) =>
  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                                ...
                                variant: 'outline',
                                className:
                                  'w-full gap-2 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 border-emerald-200',
                                children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                      ...
                      'data-prohibitions': '[]',
                      className:
                        'text-sm text-muted-foreground font-medium bg-muted px-2 py-1 rounded-md',
                      children: '45 min',
                    }),
                  ],
                }),
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
                                  ...
                                  'data-prohibitions': '[]',
                                  className:
                                    'text-xs whitespace-nowrap font-medium text-muted-foreground',
                                  children: 'Carga (kg):',
                                }),
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                          ...
                          variant: 'ghost',
                          className:
                            'h-auto flex-col gap-3 p-3 sm:p-4 hover:bg-blue-50 hover:text-blue-600',
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Frown, {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                          ...
                          variant: 'ghost',
                          className:
                            'h-auto flex-col gap-3 p-3 sm:p-4 hover:bg-slate-100 hover:text-slate-700',
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Meh, {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                          ...
                          variant: 'ghost',
                          className:
                            'h-auto flex-col gap-3 p-3 sm:p-4 hover:bg-green-50 hover:text-green-600',
                          children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                          ...
                          variant: 'ghost',
                          className:
                            'h-auto flex-col gap-3 p-3 sm:p-4 hover:bg-yellow-50 hover:text-yellow-600',
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Laugh, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                        ...
                        'data-prohibitions': '[]',
                        className:
                          'h-16 w-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto text-primary',
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                            ...
                            children:
                              'Concentre-se em suas tarefas usando a técnica Pomodoro. 25 minutos de foco profundo para estudos.',
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
...
//# sourceMappingURL=ClientDiary-Cia9MwSx.js.map
