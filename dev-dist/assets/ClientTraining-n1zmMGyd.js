            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    'data-prohibitions': '[]',
                    className:
                      'bg-primary/10 border border-primary/20 p-4 rounded-xl flex items-center justify-between mb-6',
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                    ...
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                        ...
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                            'data-uid':
                                              'src/pages/client/ClientTraining.tsx:107:29',
                                            'data-prohibitions': '[editContent]',
                                            className:
                                              'text-xs font-semibold bg-muted px-2 py-0.5 rounded text-muted-foreground',
                                            children: idx + 1,
                                          }),
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                            'data-uid':
                                              'src/pages/client/ClientTraining.tsx:110:29',
                                            'data-prohibitions': '[editContent]',
                                            className:
                                              'text-xs font-medium text-blue-600 bg-blue-50 px-2 py-0.5 rounded dark:bg-blue-900/30 dark:text-blue-400',
                                            children: ex.m,
                                          }),
                                        ],
                                      }),
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                                        ...
                                        'data-prohibitions': '[editContent]',
                                        className:
                                          'text-sm text-muted-foreground mt-1 flex items-center gap-1.5',
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Target, {
                                            'data-uid':
                                              'src/pages/client/ClientTraining.tsx:123:29',
                                            'data-prohibitions': '[editContent]',
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Accordion, {
                  ...
                  children: WEEKLY_PLANS.map((plan) =>
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
                ...
                children: LOAD_EVOLUTION.map((evo) =>
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                                ...
                                'data-prohibitions': '[editContent]',
                                className:
                                  'text-xs text-muted-foreground mb-1 font-medium flex items-center gap-1.5',
                                children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            ...
                            'data-prohibitions': '[editContent]',
                            className:
                              'flex items-center gap-2 sm:gap-3 bg-emerald-50 dark:bg-emerald-950/30 px-3 py-2 rounded-lg shrink-0 border border-emerald-100 dark:border-emerald-900/50',
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                'data-uid': 'src/pages/client/ClientTraining.tsx:221:21',
                                'data-prohibitions': '[editContent]',
                                className:
                                  'text-sm font-semibold text-muted-foreground line-through decoration-emerald-300',
                                children: evo.old,
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                                ...
                                'data-prohibitions': '[editContent]',
                                className:
                                  'text-emerald-700 dark:text-emerald-400 font-bold text-lg sm:text-xl',
                                children: evo.new,
                              }),
                            ],
                          }),
...
//# sourceMappingURL=ClientTraining-n1zmMGyd.js.map
