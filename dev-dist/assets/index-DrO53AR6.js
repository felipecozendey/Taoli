const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MasterLayout-CAwwXw9z.js","assets/dist-DWLmTnDD.js","assets/sidebar-DUahpy0S.js","assets/layout-dashboard-DmOAbry_.js","assets/ProfessionalLayout-CbJ4Hc7L.js","assets/ClientLayout-Cs-9f-nx.js","assets/dropdown-menu-Cjf8XSeA.js","assets/MasterDashboard-BR03sY9y.js","assets/PageContent-BnUjC6CJ.js","assets/MasterSettings-B8iv7XU9.js","assets/MasterUsers-RqwqgXyR.js","assets/ProfDashboard-Jlga3MuS.js","assets/ProfPatients-BiGH_Wnk.js","assets/ProfCalendar-9_lxooRZ.js","assets/ProfPrescriptions-BzipJybS.js","assets/ClientDashboard-CUjuwhgZ.js","assets/ClientDiary-5YccM0Bl.js","assets/ClientProductivity-BCCPvo2i.js","assets/ClientProgress-D8ViLcBX.js"])))=>i.map(i=>d[i]);
import { A as createSlot, B as Outlet, C as useLayoutEffect2, D as useCallbackRef, E as Root$2, F as useComposedRefs, G as __vitePreload, H as Routes, I as composeEventHandlers, J as __commonJSMin, K as require_react_dom, L as BrowserRouter, M as createContextScope, N as require_jsx_runtime, O as Primitive, R as Link, S as Portal, U as useLocation, V as Route, W as useNavigate, Y as __toESM, _ as createLucideIcon, b as useControllableState, g as X, h as cn$1, k as dispatchDiscreteCustomEvent, m as useId, n as Input, q as require_react, r as Button, s as TooltipProvider, t as Primitive$1, v as cva, w as Branch, x as Presence, y as VisuallyHidden, z as Navigate } from "./dist-DWLmTnDD.js";
...
//#endregion
//#region src/App.tsx
var MasterLayout = (0, import_react.lazy)(() => __vitePreload(() => import("./MasterLayout-CAwwXw9z.js"), __vite__mapDeps([0,1,2,3])));
var ProfessionalLayout = (0, import_react.lazy)(() => __vitePreload(() => import("./ProfessionalLayout-CbJ4Hc7L.js"), __vite__mapDeps([4,1,2,3])));
var ClientLayout = (0, import_react.lazy)(() => __vitePreload(() => import("./ClientLayout-Cs-9f-nx.js"), __vite__mapDeps([5,1,6,2,3])));
var MasterDashboard = (0, import_react.lazy)(() => __vitePreload(() => import("./MasterDashboard-BR03sY9y.js"), __vite__mapDeps([7,1,6,2,8])));
var MasterSettings = (0, import_react.lazy)(() => __vitePreload(() => import("./MasterSettings-B8iv7XU9.js"), __vite__mapDeps([9,1,6,2,8])));
var MasterUsers = (0, import_react.lazy)(() => __vitePreload(() => import("./MasterUsers-RqwqgXyR.js"), __vite__mapDeps([10,1,6,2,8])));
var ProfDashboard = (0, import_react.lazy)(() => __vitePreload(() => import("./ProfDashboard-Jlga3MuS.js"), __vite__mapDeps([11,1,6,2,8])));
var ProfPatients = (0, import_react.lazy)(() => __vitePreload(() => import("./ProfPatients-BiGH_Wnk.js"), __vite__mapDeps([12,1,6,2,8])));
var ProfCalendar = (0, import_react.lazy)(() => __vitePreload(() => import("./ProfCalendar-9_lxooRZ.js"), __vite__mapDeps([13,1,6,2,8])));
var ProfPrescriptions = (0, import_react.lazy)(() => __vitePreload(() => import("./ProfPrescriptions-BzipJybS.js"), __vite__mapDeps([14,1,6,2,8])));
var ClientDashboard = (0, import_react.lazy)(() => __vitePreload(() => import("./ClientDashboard-CUjuwhgZ.js"), __vite__mapDeps([15,1,6,2,8])));
var ClientDiary = (0, import_react.lazy)(() => __vitePreload(() => import("./ClientDiary-5YccM0Bl.js"), __vite__mapDeps([16,1,6,2,8])));
var ClientProductivity = (0, import_react.lazy)(() => __vitePreload(() => import("./ClientProductivity-BCCPvo2i.js"), __vite__mapDeps([17,1,6,2,8])));
var ClientProgress = (0, import_react.lazy)(() => __vitePreload(() => import("./ClientProgress-D8ViLcBX.js"), __vite__mapDeps([18,1,6,2,8])));
...
//#endregion
export { createCollection as _, Label as a, CardDescription as c, useAuth as d, Users as f, Activity as g, Building2 as h, useDirection as i, CardHeader as l, Sparkles as m, Root as n, Card as o, Stethoscope as p, createRovingFocusGroupScope as r, CardContent as s, Item as t, CardTitle as u };

//# sourceMappingURL=index-DrO53AR6.js.map