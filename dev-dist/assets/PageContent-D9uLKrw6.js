...
function DashboardHeader({ title, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('header', {
    ...
    className:
      'sticky top-0 z-10 flex h-16 shrink-0 items-center justify-between border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60',
    children: [
